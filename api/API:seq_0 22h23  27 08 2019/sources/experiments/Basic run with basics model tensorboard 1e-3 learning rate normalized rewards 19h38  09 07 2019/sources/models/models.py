...
def basic_seq_model(input_shape, nb_actions, use_bias=True):
	...
	model.add(Dense(256, use_bias=use_bias, kernel_initializer=RandomNormal(), bias_initializer=RandomUniform()))
	model.add(Activation('relu'))
	model.add(Dense(128, use_bias=use_bias, kernel_initializer=RandomNormal(), bias_initializer=RandomUniform()))
	model.add(Activation('relu'))
	model.add(Dense(128, use_bias=use_bias, kernel_initializer=RandomNormal(), bias_initializer=RandomUniform()))
	model.add(Activation('relu'))
	model.add(Dense(nb_actions, use_bias=use_bias, kernel_initializer=RandomNormal(), bias_initializer=RandomUniform()))
