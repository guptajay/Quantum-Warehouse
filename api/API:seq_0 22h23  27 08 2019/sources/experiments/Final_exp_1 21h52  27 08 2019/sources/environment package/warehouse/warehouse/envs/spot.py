...
class Spot():
    ...
    ## Render
    def get_patch(self, unrendered_only = False, queue = False):
        ...
        if len(self.package)>0:
            ...
            if queue:
                package,index = self.package[0],0
                patches.append(Rectangle( self.spot_corner, 1/2 , 1/2 ,edgecolor='k', facecolor= frequency_cmap(package.frequency)))    
