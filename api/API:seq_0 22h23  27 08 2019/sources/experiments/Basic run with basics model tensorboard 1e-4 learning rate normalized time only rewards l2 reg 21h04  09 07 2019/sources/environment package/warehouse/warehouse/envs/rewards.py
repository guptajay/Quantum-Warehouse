...
class BasicReward(RewardFunctionGenerator):
    ...
    def compute_reward(self, action):
        ...
        if self.action_space.is_drop_package(action):
            ...
            print('Reward : {} for dropping spot to {}')
    ...
    def spot_reward(self,spot):
        ...
        normalized_access_time_quality =  3*(access_time/self.max_access_time) + .5
        normalized_access_cost_quality = 0*(access_cost/self.max_access_cost) + .5
