...
class DescriptionCallback(Callback):
    ...
    def on_step_end(self, step, logs={}):
        ...
        self.env.manager.log_scalar('action_reward', self.env.current_stats["current_reward"])
        self.env.manager.log_scalar('action', logs['action'])
        print('action_descr :', self.env.AS.describe(logs['action']))
